...
public interface MaskPatternRepository extends CrudRepository<HistoryScanner, Integer> {
    ...
    @Query(value = "select * from history_scanner " +
            ...
            "(temperature between ?6 and ?7) ", nativeQuery = true)
    ...
    @Query(value = "select * from history_scanner where maskpattern=?1", nativeQuery = true)
    ...
    @Query(value = "select * from history_scanner " +
            ...
            "(temperature between ?4 and ?5) ", nativeQuery = true)
    ...
    @Query(value = "select * from history_scanner where (date between ?1 and ?2) and (temperature between ?3 and ?4) ", nativeQuery = true)
    ...
    @Query(value = "select * from history_scanner " +
            ...
            "(temperature between ?3 and ?4) ", nativeQuery = true)
    ...
    //    มีแค่เวลา
    @Query(value = "select * from history_scanner " +
            "where time between ?1 and ?2", nativeQuery = true)
    ...
    //    มีแค่อุณหภูมิ
    @Query(value = "select * from history_scanner " +
            "where temperature between ?1 and ?2", nativeQuery = true)
    ...
    @Query(value = "select * from history_scanner " +
            ...
            "(temperature between ?5 and ?6) ", nativeQuery = true)
